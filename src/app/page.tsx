...
export default function Home() {
  return (
    <>
        ...
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-margin-mobile max-w-4xl">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <a className="bg-primary-container text-on-primary-container px-10 py-4 font-label-sm rounded-lg hover:opacity-90 transition-all uppercase" href="https://api.whatsapp.com/send?phone=525557516268&text=Hola,%20vengo%20de%20la%20landing%20page%20y%20me%20gustar%C3%ADa%20solicitar%20informaci%C3%B3n." target="_blank" rel="noopener noreferrer">
                COTIZAR
              </a>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="bg-surface-container-lowest text-on-surface rounded-2xl shadow-xl overflow-hidden flex flex-col justify-between border border-outline-variant/30 transition-transform hover:-translate-y-2 duration-300">
                ...
                <div className="p-8 pt-0">
                  <a
                    href="https://api.whatsapp.com/send?phone=525557516268&text=Hola,%20vengo%20de%20la%20landing%20page%20y%20me%20gustar%C3%ADa%20solicitar%20informaci%C3%B3n." target="_blank" rel="noopener noreferrer"
      ...
      <a aria-label="Chat on WhatsApp" className="fixed bottom-8 right-8 z-[100] flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 group" href="https://api.whatsapp.com/send?phone=525557516268&text=Hola,%20vengo%20de%20la%20landing%20page%20y%20me%20gustar%C3%ADa%20solicitar%20informaci%C3%B3n." target="_blank">
