...
export default function Home() {
  return (
    <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="bg-surface-container-lowest text-on-surface rounded-2xl shadow-xl overflow-hidden flex flex-col justify-between border border-outline-variant/30 transition-transform hover:-translate-y-2 duration-300">
                ...
                <div className="p-8 pt-0">
                  <a
                    href="https://api.whatsapp.com/message/U7UANPSABGW4K1?autoload=1&app_absent=0" target="_blank" rel="noopener noreferrer"
      ...
      <a aria-label="Chat on WhatsApp" className="fixed bottom-8 right-8 z-[100] flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 group" href="https://api.whatsapp.com/message/U7UANPSABGW4K1?autoload=1&app_absent=0" target="_blank">
