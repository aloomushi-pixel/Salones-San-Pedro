...
export default function Home() {
  return (
    <>
        ...
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-margin-mobile max-w-4xl">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <a className="bg-primary-container text-on-primary-container px-10 py-4 font-label-sm rounded-lg hover:opacity-90 transition-all uppercase" href="https://wa.me/525557516268?text=%C2%A1Hola!%20Visit%C3%A9%20su%20sitio%20web%20y%20me%20interesa%20agendar%20mi%20evento.%20%C2%BFMe%20podr%C3%ADan%20dar%20m%C3%A1s%20detalles%3F" target="_blank" rel="noopener noreferrer">
                COTIZAR
              </a>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="bg-surface-container-lowest text-on-surface rounded-2xl shadow-xl overflow-hidden flex flex-col justify-between border border-outline-variant/30 transition-transform hover:-translate-y-2 duration-300">
                ...
                <div className="p-8 pt-0">
                  <a
                    href="https://wa.me/525557516268?text=%C2%A1Hola!%20Visit%C3%A9%20su%20sitio%20web%20y%20me%20interesa%20agendar%20mi%20evento.%20%C2%BFMe%20podr%C3%ADan%20dar%20m%C3%A1s%20detalles%3F" target="_blank" rel="noopener noreferrer"
          ...
          <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch mb-16">
              ...
              <div className="group bg-surface-container-lowest border border-outline-variant/40 rounded-2xl p-6 flex flex-col justify-between shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <a
                  href="https://wa.me/525557516268?text=%C2%A1Hola!%20Visit%C3%A9%20su%20sitio%20web%20y%20me%20interesa%20agendar%20mi%20evento.%20%C2%BFMe%20podr%C3%ADan%20dar%20m%C3%A1s%20detalles%3F"
                  target="_blank"
      ...
      <a aria-label="Chat on WhatsApp" className="fixed bottom-8 right-8 z-[100] flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 group" href="https://wa.me/525557516268?text=%C2%A1Hola!%20Visit%C3%A9%20su%20sitio%20web%20y%20me%20interesa%20agendar%20mi%20evento.%20%C2%BFMe%20podr%C3%ADan%20dar%20m%C3%A1s%20detalles%3F" target="_blank">
